...
(NULL, 'john.doe@example.com', '$2a$10$N7GjZkymUNWzmWpsLvTMpeUAEf8fZ4AzWP1KOIWY4IaxBeXfOpYmm', 'John Doe', 'avatar1.png', 1),
(NULL, 'jane.smith@example.com', '$2a$10$GZTCATobqiHPNknznX8CbuiFW/4Lr91rAfW/DaFmbviXuevBLDoGu', 'Jane Smith', 'avatar2.png', 1),
(NULL, 'mike.johnson@example.com', '$2a$10$wlsTt32wUFeEl89imMLxPeiGAnnVSbw1eVFaVC/jyviLB4nZxt4.K', 'Mike Johnson', 'avatar3.png', 1),
(1, 'sarah.williams@example.com', '$2a$10$6lnVZ6Po41a8WTn9qJyfMeiNhiZkjx/A4cYIRR7dxICgl7pk8vCra', 'Sarah Williams', 'avatar4.png', 0),
(2, 'alex.brown@example.com', '$2a$10$vsQ0I0vp7bINyqe77WaqcOlB2vUXgZaC4JhNr1.6sb36N8xekHuqO', 'Alex Brown', 'avatar5.png', 0);
